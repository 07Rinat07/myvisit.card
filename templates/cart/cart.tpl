        ...
        <section class="page-shopping-cart">
            ...
            <div class="page-shopping-cart__row">
                <div class="page-shopping-cart__img">
                    <img src="<?= HOST ?>static/img/shopping-cart/img-01.jpg" alt="productName" />
                </div>
            ...
            <div class="page-shopping-cart__row">
                <div class="page-shopping-cart__img">
                    <img src="<?= HOST ?>static/img/shopping-cart/img-02.jpg" alt="productName" />
                </div>
            ...
            <div class="page-shopping-cart__row">
                <div class="page-shopping-cart__img">
                    <img src="<?= HOST ?>static/img/shopping-cart/img-03.jpg" alt="productName" />
                </div>
